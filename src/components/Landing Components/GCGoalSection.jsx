    ...
    <section ref={sectionRef} className="relative py-20 sm:py-28 text-white overflow-hidden font-sans">
      ...
      <div className={`relative z-10 max-w-6xl mx-auto px-5 sm:px-8 text-center transition-all duration-1000 ease-out ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-12">
          {[
            { img: MissionIcon, title: "Our Mission", text: "RecipAI allows you to manage your accounts. You can freely view, update, and even delete your account anytime.", delay: "delay-[200ms]" },
            { img: VisionIcon,  title: "Our Vision",  text: "RecipAI allows you to view recipes generated by an AI based on your preferences and available ingredients.", delay: "delay-[400ms]" },
            { img: ValuesIcon,  title: "Our Values",  text: "RecipAI allows you to store your activity or history to recommend and provide better suggestions in the future.", delay: "delay-[600ms]" },
          ].map((item, index) => (
            <div
              key={index}
