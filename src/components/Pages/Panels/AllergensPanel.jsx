// src/components/AllergensPanel/AllergensPanel.jsx
import InfoPill from "./Pills";

const AllergensPanel = ({ allergens = [], dislikes = [] }) => {
          ...
          {allergens.length > 0 && (
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-bold text-gray-950 text-base tracking-tight">Strict Allergens:</p>
              </div>
          ...
          {dislikes.length > 0 && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="font-bold text-gray-950 text-base tracking-tight">Dietary Dislikes:</p>
              </div>
              <div className="flex flex-wrap gap-2.5 pl-4">
                {dislikes.map((item) => (
