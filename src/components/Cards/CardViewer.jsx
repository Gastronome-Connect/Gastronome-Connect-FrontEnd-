...
/* ── Ingredient list (collapsed to 4, expandable) ── */
      ...
      >
        ...
        <div className="flex flex-col flex-1 sm:w-[45%] bg-white overflow-hidden min-h-0">
              ...
              <div className="relative" ref={menuRef}>
                <button
                  ...
                  className={`w-8 h-8 rounded-full border flex items-center justify-center transition-colors
                    ${menuOpen
                      ? "bg-orange-50 border-orange-200 text-[#F57600]"
          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            ...
            {/* ── Ingredients ── always rendered when data exists ── */}
            <IngredientList ingredients={post.ingredients} />

            {/* ── Description ── always rendered, fallback label when empty ── */}
            {(() => {
              const hasPerMedia    = media.length > 1 && (item?.title || item?.caption);
