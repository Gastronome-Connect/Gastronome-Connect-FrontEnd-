  ...
  return (
    <>
      <motion.div
        ...
        whileHover={
          podium ? { scale: 1.04, x: 5, y: -3 } : { scale: 1.01, x: 4 }
        }
      ...
      >
        ...
        {/* Thumbnail */}
        <div
          className={`relative flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 rounded-2xl overflow-hidden shadow-sm border-2
        ...
        <div className="flex-1 min-w-0 relative z-10">
          <h4
            className={`font-black text-sm sm:text-base truncate transition-colors leading-tight
