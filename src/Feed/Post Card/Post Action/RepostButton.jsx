...
const RepostButton = ({ reposted = false, count = 0, onToggle }) => (
  <motion.button
    onClick={onToggle}
    whileTap={{ scale: 0.88 }}
    transition={{ type: "spring", stiffness: 500, damping: 18 }}
    className={`flex items-center gap-1 sm:gap-1.5 rounded-full px-3 sm:px-5 py-2.5 sm:py-3 transition-colors ${
      reposted
